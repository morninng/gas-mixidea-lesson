...
export class LessonList {
  ...
  lesson_list_sheet: GoogleAppsScript.Spreadsheet.Sheet ;
  spread_sheet: SpreadSheet;

  constructor(){
    this.spread_sheet = SpreadSheet.instance;
    this.lesson_list_sheet = this.spread_sheet.getSheet(SHEET_NAME.LESSON_LIST);
  }


  getLessonDataFromLessonId(lessonId: string): LessonData{
