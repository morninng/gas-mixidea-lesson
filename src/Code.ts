...
function getLessonData() {
  ...
  const lesson_row_num: number = getLessonIdRow(lessonId);
  const lesson_data: LessonData = getLessonDataFromRowNum(lesson_row_num);
  writeLessonData(lesson_data);
}

function writeLessonData(lesson_data: LessonData){

}


function getLessonIdRow(lessonId: string): number{
...
function getLessonDataFromRowNum(lesson_row_num: number): LessonData{
